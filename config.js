const nameGirl = 'Mẹ và em gái';
const giftUrl = 'http://nodemy.vn';
const eventName = 'Chúc Mừng 20-10';
const titleCard = 'Tặng mẹ và em gái';
const contentCard = 'Chúc mẹ và em gái có 20/10 tràn ngập niềm vui và những nụ cười. Mong điều đẹp nhất sẽ đến với mẹ và em gái trong hôm nay và cả những ngày sau luôn mạnh khoẻ ';
